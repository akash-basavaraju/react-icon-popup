...
function IconPopup(_a) {
    ...
    var _h = React.useState("right"), position = _h[0], setPosition = _h[1];
    ...
    var triggerWidth = React.useMemo(function () {
        var _a, _b;
    ...
    return (React__default.createElement("div", { style: containerStyle, className: "whole-container", ref: wrapperRef },
        React__default.createElement("div", { onClick: function (event) {
                if (onPopupTrigger) {
